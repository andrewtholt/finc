/* $Id: id3_util.c,v 1.4 2012/04/05 04:18:25 alex Exp alex $ */
/*******************************************************************************
...
static  const  GenreMap  genreLUT[]  OCD ("id3_util")  = {
    ...
    { 121, "Punk Rock" },
    { 122, "Drum Solo" },
    { 123, "A capella" },	/* Should be <two words, two "p's", two "l's">! - http://www.singers.com/a-cappella.html */
    { 124, "Euro-House" },
    { 125, "Dance Hall" },
    { 126, "Goa" },
    { 127, "Drum & Bass" },
    ...
    { 131, "Indie" },
    { 132, "BritPop" },
    { 133, "Afro Punk" },	/* Nice name for a bigoted joke entry. */
    { 134, "Polsk Punk" },
    { 135, "Beat" },
